...
T[terrain.statue] = {name: "雕像", description: "有人想装饰一下这里，很显然，没能成功…"};
T[terrain.shrub] = {name: "茂盛的灌木", description: "茂盛的灌木挡住了视线。"};
T[terrain.locked_door] = {name: "锁着的门", description: "门锁着，你需要匹配的钥匙来打开。"};
T[terrain.bed] = {name: "床", description: "柔软舒适的床。"};
T[terrain.wall_ground] = {name: "墙壁"};
T[terrain.secret_door] = {name: "墙壁"};
T[terrain.empty_sp] = {name: "地板"};
T[terrain.iron_maker] = {name: "简易铁砧", description: "简易的铁砧和锤子，可以做些东西。"};
T[terrain.tent] = {name: "帐篷", description: "一个蓝色的小帐篷。"};
T[terrain.embers] = {name: "灰烬", description: "灰烬覆盖着地板。"};
T[terrain.wall_deco] = {name: "墙壁"};
T[terrain.pedestal] = {name: "基座"};
T[terrain.well] = {name: "井"};
T[terrain.embers] = {name: "灰烬", description: "灰烬覆盖着地板。"};
T[terrain.empty_deco] = {name: "地板"};
T[terrain.bookshelf] = {name: "书架", description: "不同学科的书排满了书架。"};
T[terrain.alchemy] = {name: "炼药锅", description: "往这里投入一些种子来酿造药水。"};
T[terrain.statue_sp] = {name: "地板"};


T[terrain.shadow] = {name: "未知", description: "你不知道那里有什么。"};